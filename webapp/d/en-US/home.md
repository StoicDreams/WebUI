...
But Blazor is not without it's major issues, which we will not dive into here. But, you can check out our [One](https://blazorui.stoicdreams.com "Blazor UI documentation and website demo") to [Two](https://blazorui.stoicdreams.com "Blazor UI documentation and website demo") [Three](https://blazorui.stoicdreams.com "Blazor UI documentation and website demo") see for yourself the differences between it and what we're accomplishing here.
```
