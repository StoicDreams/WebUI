use webui::{html, paragraphs, Html, Paper};
        ...
        <>
            <Paper class="d-flex flex-row flex-wrap">
                <Paper class="flex-grow">
                    <h2 class="theme-secondary pa-1 f4">{"Welcome to the Web UI documentation and demo website"}</h2>
                    <Paper class="pa-3">
                    {paragraphs!(
                        "Welcome to the Web UI home page. We are very excited to be sharing this tool with you, as well as our journey into the world of Rust development.",
