...
pub(crate) fn page_blogs_what_is_ui_framework() -> Html {
    ...
    html! {
        <>
            ...
            {title_secondary!("What is a Website UI Framework?")}
			<Paper class={CLASSES_PAGE_SECTION}>
				{paragraphs!(
            ...
            {title_secondary!("Why Use a Website UI Framework?")}
			<Paper class={CLASSES_PAGE_SECTION}>
				{paragraphs!(
            ...
            {title_secondary!("Disadvantages of Using a Website UI Framework")}
			<Paper class={CLASSES_PAGE_SECTION}>
				{paragraphs!(
