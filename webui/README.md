...
[WebUI Version: 0.6.66](https://github.com/StoicDreams/RustWebUI)
...
# webui = { version = "0.6.66", default-features = false }
# webui = { version = "0.6.66", features = ["all"] }
# webui = { version = "0.6.66", features = ["myfi", "pages"] }
