...
[WebUI Version: 0.6.50](https://github.com/StoicDreams/RustWebUI)
...
# webui = { version = "0.6.50", default-features = false }
# webui = { version = "0.6.50", features = ["all"] }
# webui = { version = "0.6.50", features = ["myfi", "pages"] }
