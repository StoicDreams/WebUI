...
[WebUI Version: 0.6.42](https://github.com/StoicDreams/RustWebUI)
...
# webui = { version = "0.6.42", default-features = false }
# webui = { version = "0.6.42", features = ["all"] }
# webui = { version = "0.6.42", features = ["myfi", "pages"] }
