...
[WebUI Version: 0.8.1](https://github.com/StoicDreams/RustWebUI)
...
# webui = { version = "0.8.1", default-features = false }
# webui = { version = "0.8.1", features = ["all"] }
# webui = { version = "0.8.1", features = ["myfi", "pages"] }
