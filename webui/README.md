...
[WebUI Version: 0.7.18](https://github.com/StoicDreams/RustWebUI)
...
# webui = { version = "0.7.18", default-features = false }
# webui = { version = "0.7.18", features = ["all"] }
# webui = { version = "0.7.18", features = ["myfi", "pages"] }
