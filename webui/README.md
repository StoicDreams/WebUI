...
[WebUI Version: 0.7.25](https://github.com/StoicDreams/RustWebUI)
...
# webui = { version = "0.7.25", default-features = false }
# webui = { version = "0.7.25", features = ["all"] }
# webui = { version = "0.7.25", features = ["myfi", "pages"] }
