...
[WebUI Version: 0.6.71](https://github.com/StoicDreams/RustWebUI)
...
# webui = { version = "0.6.71", default-features = false }
# webui = { version = "0.6.71", features = ["all"] }
# webui = { version = "0.6.71", features = ["myfi", "pages"] }
