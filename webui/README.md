...
[WebUI Version: 0.6.69](https://github.com/StoicDreams/RustWebUI)
...
# webui = { version = "0.6.69", default-features = false }
# webui = { version = "0.6.69", features = ["all"] }
# webui = { version = "0.6.69", features = ["myfi", "pages"] }
