...
[WebUI Version: 0.7.0](https://github.com/StoicDreams/RustWebUI)
...
# webui = { version = "0.7.0", default-features = false }
# webui = { version = "0.7.0", features = ["all"] }
# webui = { version = "0.7.0", features = ["myfi", "pages"] }
