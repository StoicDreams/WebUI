...
[WebUI Version: 0.6.64](https://github.com/StoicDreams/RustWebUI)
...
# webui = { version = "0.6.64", default-features = false }
# webui = { version = "0.6.64", features = ["all"] }
# webui = { version = "0.6.64", features = ["myfi", "pages"] }
