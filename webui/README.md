...
[WebUI Version: 0.6.51](https://github.com/StoicDreams/RustWebUI)
...
# webui = { version = "0.6.51", default-features = false }
# webui = { version = "0.6.51", features = ["all"] }
# webui = { version = "0.6.51", features = ["myfi", "pages"] }
