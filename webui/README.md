...
[WebUI Version: 0.6.70](https://github.com/StoicDreams/RustWebUI)
...
# webui = { version = "0.6.70", default-features = false }
# webui = { version = "0.6.70", features = ["all"] }
# webui = { version = "0.6.70", features = ["myfi", "pages"] }
