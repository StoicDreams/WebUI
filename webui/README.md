...
[WebUI Version: 0.7.10](https://github.com/StoicDreams/RustWebUI)
...
# webui = { version = "0.7.10", default-features = false }
# webui = { version = "0.7.10", features = ["all"] }
# webui = { version = "0.7.10", features = ["myfi", "pages"] }
