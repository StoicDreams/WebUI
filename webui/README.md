...
[WebUI Version: 0.7.8](https://github.com/StoicDreams/RustWebUI)
...
# webui = { version = "0.7.8", default-features = false }
# webui = { version = "0.7.8", features = ["all"] }
# webui = { version = "0.7.8", features = ["myfi", "pages"] }
