...
[WebUI Version: 0.6.41](https://github.com/StoicDreams/RustWebUI)
...
# webui = { version = "0.6.41", default-features = false }
# webui = { version = "0.6.41", features = ["all"] }
# webui = { version = "0.6.41", features = ["myfi", "pages"] }
