...
[WebUI Version: 0.8.13](https://github.com/StoicDreams/WebUI)
...
# webui = { version = "0.8.13", default-features = false }
# webui = { version = "0.8.13", features = ["all"] }
# webui = { version = "0.8.13", features = ["myfi", "pages"] }
