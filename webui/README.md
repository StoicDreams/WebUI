...
[WebUI Version: 0.6.68](https://github.com/StoicDreams/RustWebUI)
...
# webui = { version = "0.6.68", default-features = false }
# webui = { version = "0.6.68", features = ["all"] }
# webui = { version = "0.6.68", features = ["myfi", "pages"] }
