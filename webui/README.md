...
[WebUI Version: 0.7.17](https://github.com/StoicDreams/RustWebUI)
...
# webui = { version = "0.7.17", default-features = false }
# webui = { version = "0.7.17", features = ["all"] }
# webui = { version = "0.7.17", features = ["myfi", "pages"] }
