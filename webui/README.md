...
[WebUI Version: 0.7.39](https://github.com/StoicDreams/RustWebUI)
...
# webui = { version = "0.7.39", default-features = false }
# webui = { version = "0.7.39", features = ["all"] }
# webui = { version = "0.7.39", features = ["myfi", "pages"] }
