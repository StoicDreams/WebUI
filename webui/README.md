...
[WebUI Version: 0.10.2](https://github.com/StoicDreams/WebUI)
...
# webui = { version = "0.10.2", default-features = false }
# webui = { version = "0.10.2", features = ["all"] }
# webui = { version = "0.10.2", features = ["myfi", "pages"] }
