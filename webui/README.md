...
[WebUI Version: 0.7.27](https://github.com/StoicDreams/RustWebUI)
...
# webui = { version = "0.7.27", default-features = false }
# webui = { version = "0.7.27", features = ["all"] }
# webui = { version = "0.7.27", features = ["myfi", "pages"] }
