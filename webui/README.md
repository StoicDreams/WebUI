...
[WebUI Version: 0.7.9](https://github.com/StoicDreams/RustWebUI)
...
# webui = { version = "0.7.9", default-features = false }
# webui = { version = "0.7.9", features = ["all"] }
# webui = { version = "0.7.9", features = ["myfi", "pages"] }
