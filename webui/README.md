...
[WebUI Version: 0.7.34](https://github.com/StoicDreams/RustWebUI)
...
# webui = { version = "0.7.34", default-features = false }
# webui = { version = "0.7.34", features = ["all"] }
# webui = { version = "0.7.34", features = ["myfi", "pages"] }
