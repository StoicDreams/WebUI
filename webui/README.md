...
[WebUI Version: 0.7.40](https://github.com/StoicDreams/RustWebUI)
...
# webui = { version = "0.7.40", default-features = false }
# webui = { version = "0.7.40", features = ["all"] }
# webui = { version = "0.7.40", features = ["myfi", "pages"] }
