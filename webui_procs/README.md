...
[WebUI Version: 0.8.7](https://github.com/StoicDreams/WebUI)
...
# webui = { version = "0.8.7", default-features = false }
# webui = { version = "0.8.7", features = ["all"] }
# webui = { version = "0.8.7", features = ["myfi", "pages"] }
