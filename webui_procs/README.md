...
[WebUI Version: 0.8.8](https://github.com/StoicDreams/WebUI)
...
# webui = { version = "0.8.8", default-features = false }
# webui = { version = "0.8.8", features = ["all"] }
# webui = { version = "0.8.8", features = ["myfi", "pages"] }
