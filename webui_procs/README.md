...
[WebUI Version: 0.7.22](https://github.com/StoicDreams/RustWebUI)
...
# webui = { version = "0.7.22", default-features = false }
# webui = { version = "0.7.22", features = ["all"] }
# webui = { version = "0.7.22", features = ["myfi", "pages"] }
