...
[WebUI Version: 0.7.23](https://github.com/StoicDreams/RustWebUI)
...
# webui = { version = "0.7.23", default-features = false }
# webui = { version = "0.7.23", features = ["all"] }
# webui = { version = "0.7.23", features = ["myfi", "pages"] }
