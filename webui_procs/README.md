...
[WebUI Version: 0.7.35](https://github.com/StoicDreams/RustWebUI)
...
# webui = { version = "0.7.35", default-features = false }
# webui = { version = "0.7.35", features = ["all"] }
# webui = { version = "0.7.35", features = ["myfi", "pages"] }
