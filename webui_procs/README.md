...
[WebUI Version: 0.8.10](https://github.com/StoicDreams/WebUI)
...
# webui = { version = "0.8.10", default-features = false }
# webui = { version = "0.8.10", features = ["all"] }
# webui = { version = "0.8.10", features = ["myfi", "pages"] }
