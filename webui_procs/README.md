...
[WebUI Version: 0.11.6](https://github.com/StoicDreams/WebUI)
...
# webui = { version = "0.11.6", default-features = false }
# webui = { version = "0.11.6", features = ["all"] }
# webui = { version = "0.11.6", features = ["myfi", "pages"] }
