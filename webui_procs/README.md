...
[WebUI Version: 0.7.37](https://github.com/StoicDreams/RustWebUI)
...
# webui = { version = "0.7.37", default-features = false }
# webui = { version = "0.7.37", features = ["all"] }
# webui = { version = "0.7.37", features = ["myfi", "pages"] }
