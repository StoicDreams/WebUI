...
[WebUI Version: 0.8.9](https://github.com/StoicDreams/WebUI)
...
# webui = { version = "0.8.9", default-features = false }
# webui = { version = "0.8.9", features = ["all"] }
# webui = { version = "0.8.9", features = ["myfi", "pages"] }
