...
[WebUI Version: 0.7.36](https://github.com/StoicDreams/RustWebUI)
...
# webui = { version = "0.7.36", default-features = false }
# webui = { version = "0.7.36", features = ["all"] }
# webui = { version = "0.7.36", features = ["myfi", "pages"] }
