...
[WebUI Version: 0.7.29](https://github.com/StoicDreams/RustWebUI)
...
# webui = { version = "0.7.29", default-features = false }
# webui = { version = "0.7.29", features = ["all"] }
# webui = { version = "0.7.29", features = ["myfi", "pages"] }
